...
import uz.javlon.webapp.client.ui.navigation.DesktopNavigationBar;
import uz.javlon.webapp.client.ui.navigation.DesktopSideNavigationBar;
...
public class DesktopShell extends Shell implements LoginEvent.Handler, LogoutEvent.Handler, PlaceChangeEvent.Handler {
    ...
    @UiField
    DesktopNavigationBar navigationBar;
    @UiField
    DesktopSideNavigationBar sideNavigationBar;
